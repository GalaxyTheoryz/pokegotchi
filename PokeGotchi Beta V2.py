...
name_choice= input ("Would you like to generate a random name or custom?")
if name_choice== "Random Name":
    import random
    foo = ['Hannah', 'Bolton', 'Stephens', 'Fox', 'Raywood', 'MrBlingBling', 'Watson', 'HALIEEEEEEEEEEEEEE'  ]
    secure_random = random.SystemRandom()
    print(secure_random.choice(foo))
    name_happy =input ("Are you happy with this name?")
    if name_happy== "Yes":
        print ("Preparing Options")
    if name_happy== "No":
        import random
        foo = ['Hannah', 'Bolton', 'Stephens', 'Fox', 'Raywood', 'MrBlingBling', 'Watson', 'HALIEEEEEEEEEEEEEE'  ]
        secure_random = random.SystemRandom()
...
menu= input ("Welcome to your Main Menu, please select an option. 1 - Re-cycle through all options. 2 - Play. 3 - Exit 4 - Health Status. 5 - Custom Feed Please select a number.")    
